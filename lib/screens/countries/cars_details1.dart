...
class _CarDetailsState extends State<CarDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    void navigateToNewScreen(String option) {
      // Use Navigator to navigate to a new screen based on the selected option.
      if (option == 'Edit') {
        Navigator.push(
          context,
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: GestureDetector(
            onTap: () {
/*
              GoRouter.of(context).push(AppRouter.kCustomPopupMenu);
*/
            },
            child: Row(
          ...
          actions: [
            PopupMenuButton<String>(
              constraints: BoxConstraints(
                  maxWidth: screenWidth * .533,
                  maxHeight: screenHeight * .12,
                  minWidth: screenWidth * .33,
